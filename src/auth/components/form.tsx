...
export const AuthForm = ({ formType }: Props) => {
    return (
        <>
            ...
            <div id="auth-error-message" class="h-6 text-base text-red-500">
            ...
            <form
                ...
                class="m-0"
                hx-target-error="#auth-error-message"
                hx-swap="innerHTML"
            >
                <div class="mb-2">
                    <label for="username" class="block mb-1 text-lg">Username</label>
                    <input autofocus tabindex={1} class="w-full border border-black p-2 rounded text-md" type="text" id="username" name="username" required />
                </div>
                <div class="mb-8">
                ...
                <div class="flex flex-row justify-between" hx-ext="response-targets">
